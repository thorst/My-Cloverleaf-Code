if 0 {
	...
	Change Log:
		...
		2015-04-24 Todd Horst
			-Ignore \{ and \} and \#, people may have it in a string
		...
		2016
			-Added isBlob to allow you to send not a file
...
proc _scriptFormat {script {options ""}} {
	...
	foreach line [split $data \n] {
		...
		set line [string map [list \t $tabStr] $line]
	...
	if {[dict exists $options "isBlob"] && [dict get $options "isBlob"]} {
		...
		return [_baseEncode [join $newData "\n"]]
	} else {
